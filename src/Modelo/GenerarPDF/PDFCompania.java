...
public class PDFCompania {
    public void generarPDF(JTable tablaCia) {
        try {
            ...
            latexContent.append("\\section{Reporte de Compañías}\n");
            latexContent.append("\\begin{longtable}{|c|c|c|c|}\n");
            latexContent.append("\\hline\n");
            latexContent.append("CodCia & DesCia & DesCorta & Vigente \\\\\n");
            latexContent.append("\\hline\n");
