 ...
 * @author angel
 */
public class PDFPartidasProyectoIngreso {
    public void generarPDF(JTable tablaProy_Partida_I) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaProy_Partida_I.getModel();
            ...
            latexContent.append("\\section{Reporte de Partidas de Proyecto (Ingreso)}\n");
            ...
            try (FileWriter fw = new FileWriter("reportePartidasProyectoIngreso.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reportePartidasProyectoIngreso.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reportePartidasProyectoIngreso.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Partidas Proyecto\\reportePartidasProyectoIngreso.pdf"), StandardCopyOption.REPLACE_EXISTING);
