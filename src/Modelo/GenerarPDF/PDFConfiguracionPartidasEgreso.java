 ...
 * @author angel
 */
public class PDFConfiguracionPartidasEgreso {
    public void generarPDF(JTable tablaPartidaMezcla_E) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaPartidaMezcla_E.getModel();
            ...
            latexContent.append("\\section{Reporte de Configuración de Partidas de Egreso}\n");
            ...
            try (FileWriter fw = new FileWriter("reporteConfiguracionPartidasEgreso.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reporteConfiguracionPartidasEgreso.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reporteConfiguracionPartidasEgreso.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Configuracion Partidas\\reporteConfiguracionPartidasEgreso.pdf"), StandardCopyOption.REPLACE_EXISTING);
