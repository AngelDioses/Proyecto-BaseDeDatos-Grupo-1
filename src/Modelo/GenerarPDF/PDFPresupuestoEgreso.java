 ...
 * @author angel
 */
public class PDFPresupuestoEgreso {
    public void generarPDF(JTable tablaDProy_Partida_E) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaDProy_Partida_E.getModel();
            ...
            try (FileWriter fw = new FileWriter("reportePresupuestoEgreso.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reportePresupuestoEgreso.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reportePresupuestoEgreso.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Presupuesto\\reportePresupuestoEgreso.pdf"), StandardCopyOption.REPLACE_EXISTING);
