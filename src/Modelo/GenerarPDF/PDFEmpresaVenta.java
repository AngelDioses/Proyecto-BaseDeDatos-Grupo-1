 ...
 * @author angel
 */
public class PDFEmpresaVenta {
    public void generarPDF(JTable tablaEmpresa) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaEmpresa.getModel();
            ...
            latexContent.append("\\section{Reporte de Empresa Venta}\n");
            latexContent.append("\\begin{tabular}{|c|c|c|c|c|c|c|}\n");
            latexContent.append("\\hline\n");
            latexContent.append("CodPersona & DescPersona & NroRuc & Tipo Empresa & FecIni & FecFin & Vigente \\\\\n");
            latexContent.append("\\hline\n");
            ...
            try (FileWriter fw = new FileWriter("reporteEmpresaVenta.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reporteEmpresaVenta.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reporteEmpresaVenta.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Empresa Venta\\reporteEmpresaVenta.pdf"), StandardCopyOption.REPLACE_EXISTING);
