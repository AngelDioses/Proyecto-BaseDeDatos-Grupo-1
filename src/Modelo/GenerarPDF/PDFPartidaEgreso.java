 ...
 * @author angel
 */
public class PDFPartidaEgreso {
    public void generarPDF(JTable tablaPartida_E) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaPartida_E.getModel();
            ...
            try (FileWriter fw = new FileWriter("reportePartidasEgreso.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reportePartidasEgreso.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reportePartidasEgreso.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Partidas\\reportePartidasEgreso.pdf"), StandardCopyOption.REPLACE_EXISTING);
