 ...
 * @author angel
 */
public class PDFEgresos {
    public void generarPDF(JTable tablaCompra) {
        try {
            // Obtener el modelo de la tabla
            TableModel model = tablaCompra.getModel();
            ...
            latexContent.append("\\section{Reporte de Egresos}\n");
            ...
            try (FileWriter fw = new FileWriter("reporteEgresos.tex")) {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:\\Users\\angel\\AppData\\Local\\Programs\\MiKTeX\\miktex\\bin\\x64\\pdflatex.exe", "reporteEgresos.tex");
            ...
            if (exitCode == 0) {
                ...
                Files.move(Paths.get("reporteEgresos.pdf"), Paths.get("C:\\Users\\angel\\Desktop\\REPORTES PDF\\Egresos\\reporteEgresos.pdf"), StandardCopyOption.REPLACE_EXISTING);
